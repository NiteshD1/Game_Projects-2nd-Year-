...
var adInterstitialId = "ca-app-pub-4371541916347832/2244437779" # [Replace with your Ad Unit ID and delete this message.]
var adRewardedId = "ca-app-pub-4371541916347832/2052866089" # [There is no testing option for rewarded videos, so you can use this id for testing]
...
func _on_coinadd_pressed():
	if admob != null and !utils.network_error:
		admob.showRewardedVideo()
	else:
		utils.emit_signal("networkerror")
#		get_node("Label").show()
...
#	yield(utils.create_timer(0.5),"timeout")
	if admob != null and (utils.fileobj[715] > 2):
		admob.showInterstitial()
	pass # replace with function body
