...
func _on_guide_pressed():
	audio.get_node("SamplePlayer2D").play("hit")
	get_node("guide").set_scale(Vector2(0.55,0.55))
	pass # replace with function body


func _on_guide_released():
	get_node("guide").set_scale(Vector2(0.5,0.5))
	pass # replace with function body


func _on_rateus_pressed():
	audio.get_node("SamplePlayer2D").play("hit")
	get_node("rateus").set_scale(Vector2(0.55,0.55))
	OS.shell_open("https://play.google.com/store/apps/details?id=org.studyquiz.mathpuzzle")
	pass # replace with function body


func _on_rateus_released():
	get_node("rateus").set_scale(Vector2(0.5,0.5))
	pass # replace with function body


func _on_share_pressed():
	audio.get_node("SamplePlayer2D").play("hit")
	get_node("share").set_scale(Vector2(0.55,0.55))
	pass # replace with function body


func _on_share_released():
	get_node("share").set_scale(Vector2(0.5,0.5))
	pass # replace with function body
